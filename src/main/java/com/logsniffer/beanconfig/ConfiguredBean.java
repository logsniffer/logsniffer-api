...
public interface ConfiguredBean {
	...
	public static class ConfiguredBeanTypeIdResolver implements TypeIdResolver {
		...
		public JavaType typeFromId(final DatabindContext context, final String id) {
			return context.constructType(
					beanTypeResolver.resolveTypeClass(id, (Class<ConfiguredBean>) baseType.getRawClass()));
		}
	 ...
	 * 
	 */
	public static class ConfiguredBeanDeserializer extends StdDeserializer<ConfiguredBean>
		...
		@Override
		public ConfiguredBean deserialize(final JsonParser jp, final DeserializationContext ctxt)
				throws IOException, JsonProcessingException {
			final ConfiguredBean bean = (ConfiguredBean) defaultDeserializer.deserialize(jp, ctxt);
			ContextProvider.getContext().getBean(BeanConfigFactoryManager.class).postConstruct(bean);
			return bean;
		}
