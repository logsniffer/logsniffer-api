...
import com.logsniffer.field.FieldsMap.FieldsMapTypeSafeDeserializer;
import com.logsniffer.field.FieldsMap.FieldsMapTypeSafeSerializer;

/**
 * Base map for all log fragment types with support for type-safe JSON
...
public class FieldsMap extends LinkedHashMap<String, Object> implements FieldsMapPublicSerializationMixIn {
	...
	/**
	 * Constructs fields map with entries copied from given copy.
	 * 
	 * @param copy
	 *            map with entries to copy from
	 */
	public FieldsMap(final Map<String, Object> copy) {
		super(copy);
	}
